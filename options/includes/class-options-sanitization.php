 ...
 */
 ...
 if (!function_exists('of_sanitize_textarea')) {
		...
		function of_recognized_background_repeat() {
			$default = array(
				'no-repeat' => __( 'No Repeat', 'iv_postman' ),
				'repeat-x'  => __( 'Repeat Horizontally', 'iv_postman' ),
				'repeat-y'  => __( 'Repeat Vertically', 'iv_postman' ),
				'repeat'    => __( 'Repeat All', 'iv_postman' ),
				);
		...
		function of_recognized_background_position() {
			$default = array(
				'top left'      => __( 'Top Left', 'iv_postman' ),
				'top center'    => __( 'Top Center', 'iv_postman' ),
				'top right'     => __( 'Top Right', 'iv_postman' ),
				'center left'   => __( 'Middle Left', 'iv_postman' ),
				'center center' => __( 'Middle Center', 'iv_postman' ),
				'center right'  => __( 'Middle Right', 'iv_postman' ),
				'bottom left'   => __( 'Bottom Left', 'iv_postman' ),
				'bottom center' => __( 'Bottom Center', 'iv_postman' ),
				'bottom right'  => __( 'Bottom Right', 'iv_postman')
				);
		...
		function of_recognized_background_attachment() {
			$default = array(
				'scroll' => __( 'Scroll Normally', 'iv_postman' ),
				'fixed'  => __( 'Fixed in Place', 'iv_postman')
				);
		...
		function of_recognized_font_styles() {
			$default = array(
				'normal'      => __( 'Normal', 'iv_postman' ),
				'italic'      => __( 'Italic', 'iv_postman' ),
				'bold'        => __( 'Bold', 'iv_postman' ),
				'bold italic' => __( 'Bold Italic', 'iv_postman' )
				);
