...
class iv_postman_Options_Framework_Interface
{
    ...
    public static function optionsframework_fields()
    {
        ...
        foreach ($options as $value) {
            ...
            // Uploader
            case "upload":
                $output .= iv_postman_Options_Framework_Media_Uploader::optionsframework_uploader($value['id'], $val, null);
            ...
            case 'background':
                ...
                $output .= iv_postman_Options_Framework_Media_Uploader::optionsframework_uploader($value['id'], $background['image'], null, esc_attr($option_name . '[' . $value['id'] . '][image]'));
        ...
        if (iv_postman_Options_Framework_Interface::optionsframework_tabs() != '') {
            echo '</div>';
        }
    }
}
