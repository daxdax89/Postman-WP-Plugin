...
class iv_postman_Options_Framework {
	...
	function get_option_name() {
		...
		if ( function_exists( 'iv_postman_optionsframework_option_name' ) ) {
			$name = iv_postman_optionsframework_option_name();
		}
	...
	/**
	 * Wrapper for iv_postman_optionsframework()
	 *
	 ...
	 */
	static function &_iv_postman_optionsframework() {
		static $options = null;
		...
		if ( !$options ) {
	        ...
	        if ( $optionsfile = locate_template( $location ) ) {
	            ...
	            } else if ( function_exists( 'iv_postman_optionsframework' ) ) {
